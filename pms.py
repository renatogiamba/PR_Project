...
damping= 1
num_iterations= 20
XR,XL, chi_stats_p, num_inliers_p, chi_stats_r, num_inliers_r, H, b= ls.do_total_ls(XR_guess,XL_guess,Zp,projection_associations,Zr,num_iterations,damping,kernel_threshold, num_poses, pose_dim, num_landmarks, landmark_dim, K, cam_pose, z_near, image_rows, image_cols)
