...
def do_total_ls(XR, XL, Zp, projection_associations, Zr, num_iterations, damping, kernel_threshold, num_poses, pose_dim, num_landmarks, landmark_dim, K, cam_pose, z_near, image_rows, image_cols):
